...
m_dict = {0.1:{'slow':[-0.1392174705], 'medium':[-0.141666667], 'fast':[-0.21651701]},
          0.2:{'slow':[-0.1092343614], 'medium':[-0.1432255834], 'fast':[-0.2249777586]},
          0.4:{'slow':[-0.11666667], 'medium':[-0.184286399], 'fast':[-0.227764652]}}
b_dict = {0.1:{'slow':[1.402957235], 'medium':[1.375000002], 'fast':[1.779102084]},
          0.2:{'slow':[1.18964053], 'medium':[1.370804667], 'fast':[2.349866552]},
          0.4:{'slow':[1.525], 'medium':[2.065718394], 'fast':[2.226587909]}}
...
p_dict = {0.1:{'slow':[5.0575e9], 'medium':[10**9.071], 'fast':[6*10**7]},
          0.2:{'slow':[10**9], 'medium':[10**8], 'fast':[6*10**9]},
          0.4:{'slow':[6*10**9], 'medium':[9.649e8], 'fast':[6.311e7]}}
